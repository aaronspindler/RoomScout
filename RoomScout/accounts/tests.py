...
class LoginTest(TestCase):
	...
	def test_login_form_post(self):
		...
		response = self.client.post('/signup', {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': 'LoginTest',
		                                        'email': 'Login@test.com', 'password1': 'django1234',
		                                        'password2': 'django1234', 'address': '1234 Main St',
		                                        'city': 'Vancouver', 'province': 'ON', 'postal_code': 'K7M 0M4'})
...
class SignupTest(TestCase):
	...
	def test_signup_form_post_invalid(self):
		...
		response = self.client.post('/signup',
		                            {'first_name': '', 'last_name': '', 'username': '', 'email': '', 'password1': '',
		                             'password2': '', 'address': '', 'city': '', 'postal_code': ''})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 200)
		...
		pre_count = User.objects.count()
		response = self.client.post('/signup', {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': '',
		                                        'email': 'testing@1234.com', 'password1': 'django1234',
		                                        'password2': 'django1234', 'address': '1234 Main St',
		                                        'city': 'Vancouver', 'province': 'ON', 'postal_code': 'K7M 0M4'})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 200)
		...
		pre_count = User.objects.count()
		response = self.client.post('/signup', {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': 'xNovax123',
		                                        'email': '', 'password1': 'django1234', 'password2': 'django1234',
		                                        'address': '1234 Main St', 'city': 'Vancouver', 'province': 'ON',
		                                        'postal_code': 'K7M 0M4'})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 200)
		self.assertEqual(pre_count, post_count)
		...
		pre_count = User.objects.count()
		response = self.client.post('/signup', {'first_name': '', 'last_name': 'Spindler', 'username': 'xNovax1234',
		                                        'email': 'testing@test.com', 'password1': 'django1234',
		                                        'password2': 'django1234', 'address': '1234 Main St',
		                                        'city': 'Vancouver', 'province': 'ON', 'postal_code': 'K7M 0M4'})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 200)
		...
		pre_count = User.objects.count()
		response = self.client.post('/signup', {'first_name': 'Aaron', 'last_name': '', 'username': 'xNovax123469',
		                                        'email': 'testing69@test.com', 'password1': 'django1234',
		                                        'password2': 'django1234', 'address': '1234 Main St',
		                                        'city': 'Vancouver', 'province': 'ON', 'postal_code': 'K7M 0M4'})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 200)
	...
	def test_signup_form_post_repeat(self):
		...
		# Create a user
		pre_count = User.objects.count()
		response = self.client.post('/signup', {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': 'xNovax',
		                                        'email': 'aaron@xnovax.net', 'password1': 'django1234',
		                                        'password2': 'django1234', 'address': '1234 Main St',
		                                        'city': 'Vancouver', 'province': 'ON', 'postal_code': 'K7M 0M4'})
		post_count = User.objects.count()
		self.assertEqual(response.status_code, 302)
		...
		pre_count = User.objects.count()
		response = self.client.post('/signup',
		                            {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': 'xNova1104x',
		                             'email': 'aaron@xnovax.net', 'password1': 'django1234', 'password2': 'django1234',
		                             'address': '1234 Main St', 'city': 'Vancouver', 'province': 'ON',
		                             'postal_code': 'K7M 0M4'})
		self.assertEqual(response.status_code, 200)
		post_count = User.objects.count()
		...
		response = self.client.post('/signup',
		                            {'first_name': 'Aaron', 'last_name': 'Spindler', 'username': 'xNova1104x',
		                             'email': 'nova1104@live.com', 'password1': 'django1234', 'password2': 'django1234',
		                             'address': '1234 Main St', 'city': 'Vancouver', 'province': 'ON',
		                             'postal_code': 'K7M 0M4'})
		self.assertEqual(response.status_code, 302)
		post_count = User.objects.count()
