...
class HouseTests(TestCase):
	...
	def test_create_default_house(self):
		...
		self.assertEqual(house.street_number, 0)
		...
		self.assertEqual(house.num_rooms, -1)
		self.assertEqual(house.num_bathrooms, -1)
		self.assertEqual(house.num_parking_spaces, -1)
		self.assertFalse(house.pets_allowed)
		self.assertEqual(house.num_male, -1)
		self.assertEqual(house.num_female, -1)
